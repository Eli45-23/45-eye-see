...
const content = getLocalAreaPage("manhattan-electrician");

export const metadata: Metadata = {
  title: content.title,
  description: content.description,
  alternates: {
    canonical: "https://45eyeelectricalsolutions.com/manhattan-electrician",
  },
  openGraph: {
    title: content.title,
    description: content.description,
    url: "https://45eyeelectricalsolutions.com/manhattan-electrician",
...
export default function ManhattanElectricianPage() {
  const schema = getLocalAreaElectricianSchema(content.areaName, "/manhattan-electrician");
